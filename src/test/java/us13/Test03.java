...
public class Test03 extends Utilities13 {
    ...
    void Test01() {
        ...
        //8	 Last name boş birakilmali
        //9	 Company name'e gecrli bir veri girebilmeli
        driver.findElement(By.cssSelector("#shipping_first_name")).sendKeys("Zafer",Keys.TAB,  Keys.TAB, "ZA");
        waitForSecond(2);
        ...
        driver.findElement(By.name("shipping_address_2")).sendKeys("No:13, D:5", Keys.TAB, "34000", Keys.TAB, "Pendik");
        waitForSecond(2);
        ...
        //17 "Last name is a required field." yazisi gozükür
