...
public class Test05 extends Utilities13{
    ...
    void test01() {
        ...
        //11 Street address boş birakilmali
        ...
        WebElement saveBox=driver.findElement(By.xpath("//*[text()='Save address']"));
        saveBox.click();

        //17"Street address is a required field." yazisi gozükür
